...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument(
            ...
            default="/mnt/disk/kitti",
        )
        self.parser.add_argument(
            "--log_dir", type=str, help="log directory", default="ckpts"
        )
        ...
        self.parser.add_argument(
            "--num_epochs", type=int, help="number of epochs", default=40
        )
        self.parser.add_argument(
            "--scheduler_step_size",
            type=int,
        ...
        self.parser.add_argument(
            ...
            action="store_true",
            default=False,
            help="if set, uses inr filter for postprocessing the depth map",
        )
        ...
        self.parser.add_argument(
            "--num_workers", type=int, help="number of dataloader workers", default=16
        )
